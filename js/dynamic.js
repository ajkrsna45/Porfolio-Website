...
const projects = [{
        name: ["Course Project", "", "Web Dev", "2022"],
        description: "Curd implementation : Can be used in manage courses in an educational organization. Features: Adding a new course, delegating course, updating course",
        featured_image: ["images/9-1.png", "images/9-1.png"],
        technologie: ["html", "css", "javaScript", "ReactJs", "Bootstrap"],
        link: [
            "https://coursemanagementsystembyajaygupta.000webhostapp.com/",
            // "https://github.com/emperor-2001/QuickZIP",
        ],
    },
    {
        name: ["Tic Tac Toe", "", "Web Dev", "2022"],
        description: `To make on the old and popular game, we can
        also play the game with our friends on a web
        browser.`,
        featured_image: ["images/unnamed.png", "images/unnamed.png"],
        technologie: ["html", "css", "javscript", "reactjs"],
        link: [
    ...
    {
        name: ["Fetching news using API", "", "Web Dev", "2022"],
        description: `To make on the old and popular game, we can
        also play the game with our friends on a web
        browser.`,
        featured_image: ["images/news.jpg", "images/news.jpg"],
        technologie: ["html", "css", "javscript", "reactjs"],
        link: [
            "https://sketch-n-chat.herokuapp.com/",
            "https://github.com/emperor-2001/SketchNChat",
    ...
    {
        name: ["Cost of living", "", "Data Science", "2022"],
        description: `• This analysis is based on getting the cost of living in different-2 parts of the world
        • Technology used: Data Science
        • Language: Python
        • Libraries : Numpy , Pandas, Matplotlib,
        Seaborn, ipywidgets
        • Features: Data Cleaning, Data Visualization,
        Data Query, Data Featuring`,
        featured_image: ["images/2-2.png", "images/2-2.png"],
        technologie: ["Python", "Data Science", "Numpy", "Pandas","Matplotlib"],
        link: [
            // "https://sketch-n-chat.herokuapp.com/",
            "https://github.com/ajkrsna45/Cost-of-Living",
        ],
    },
    // {
...
const languages = [{
        ...
        // image: "<i class="fa-brands fa-python"></i>",
    },
    {
        name: "JavaScript",
        image: "images/js.png",
...
const skills = {
    ...
    tools: ["GitHub", "VS Code", "Chrome Dev Tools"],
    professional: [
